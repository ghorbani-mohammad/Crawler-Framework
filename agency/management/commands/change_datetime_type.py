...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        cursor.execute('''ALTER TABLE agency_agency ALTER COLUMN deleted_at TYPE "timestamp"''')
        cursor.execute('''ALTER TABLE agency_agencypagestructure ALTER COLUMN updated_at TYPE "timestamp"''')
        cursor.execute('''ALTER TABLE agency_agencypagestructure ALTER COLUMN last_crawl TYPE "timestamp"''')